...
namespace AutoPart.Areas.Admin.Controllers
{
    public class MessagesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Email,Subject,MessageContent")] Message message)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Email,Subject,MessageContent")] Message message)
        {
            if (ModelState.IsValid)
            {
